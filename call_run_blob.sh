...
call_run_blob  $with_gc_dir $num_keys $with_gc_dir $with_gc_dir $enable_blob_file $enable_blob_gc | tee with_gc.txt
...
call_run_blob  $without_gc_dir $num_keys $without_gc_dir $without_gc_dir $enable_blob_file $enable_blob_gc | tee without_gc.txt
