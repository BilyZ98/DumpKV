...
use_shared_block_and_blob_cache=${USE_SHARED_BLOCK_AND_BLOB_CACHE:-0}
...
for job in ${jobs[@]}; do
  ...
  elif [ $job = ssd_trace ]; then
    run_ssd_trace ssd_trace ssd_trace ssd_trace
